...
export const PREVIEW_AUTOMATION_HOVER_CHANNEL = "desktop:preview-automation-hover";
export const PREVIEW_AUTOMATION_SELECT_CHANNEL = "desktop:preview-automation-select";
