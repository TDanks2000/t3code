...
describe("resolveThreadRowClassName", () => {
  it("uses the darker selected palette when a thread is both selected and active", () => {
    ...
    expect(className).toContain("bg-primary/25");
    expect(className).toContain("hover:bg-primary/30");
    expect(className).toContain("dark:bg-primary/35");
  ...
  it("uses selected hover colors for selected threads", () => {
    ...
    expect(className).toContain("hover:bg-primary/22");
    expect(className).toContain("dark:bg-primary/25");
  ...
  it("keeps the accent palette for active-only threads", () => {
    ...
    expect(className).toContain("hover:bg-accent/90");
  });
});
